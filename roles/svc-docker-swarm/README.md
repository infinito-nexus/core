...
hosts in the Ansible group `svc-docker-swarm`. The manager is the single
host in `svc-docker-swarm-manager`; every other group member joins as a
...
- **Auto-derived workers:** `svc-docker-swarm - svc-docker-swarm-manager`
