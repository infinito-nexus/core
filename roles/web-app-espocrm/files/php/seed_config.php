<?php
// nocheck: mirrored-unit-test - requires /var/www/html/bootstrap.php at the top level
// and drives EspoCRM's own config container; nothing here runs without the install
/**
