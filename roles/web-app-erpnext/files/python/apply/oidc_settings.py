# nocheck: mirrored-unit-test - imports frappe and frappe.utils.password at module level
# and runs inside `bench execute`; the framework is not installable outside the ERPNext
# image
import json
import os
