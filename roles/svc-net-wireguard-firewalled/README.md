...
Run the published image to provision the inventory and deploy WireGuard Client behind NAT to a managed server (the mounted volume persists the inventory):
