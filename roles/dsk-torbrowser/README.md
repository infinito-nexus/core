...
The `dsk-torbrowser` role uses the `community.general.pacman` module to:
...
cd core
make onboard
make compose-deploy mode=reinstall apps=dsk-torbrowser full_cycle=false
```
