...
```mermaid
flowchart LR
    subgraph role [desk-agnt-claude 💻]
        svc_agnt_claude["agnt-claude"]
    end
```
...
cd core
make onboard
make compose-deploy mode=reinstall apps=desk-agnt-claude full_cycle=false
```
