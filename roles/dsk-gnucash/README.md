...
cd core
make onboard
make compose-deploy mode=reinstall apps=dsk-gnucash full_cycle=false
```
...
The `dsk-gnucash` role ensures that GnuCash is installed and maintained at its latest available version in the Pacman repositories.
