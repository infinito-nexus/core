// nocheck: mirrored-unit-test - requires ep_etherpad-lite's Settings module at load
// time and reads settings.ep_redis_publisher, so it cannot be imported outside an
// Etherpad install
const redis = require('redis');
const settings = require('ep_etherpad-lite/node/utils/Settings');
const logger = { error: (...args) => console.error('[ep_redis_publisher]', ...args) };
