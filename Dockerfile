...
ARG INFINITO_PYTHON_INSTALL_SCRIPT
ENV INFINITO_PYTHON_INSTALL_SCRIPT=${INFINITO_PYTHON_INSTALL_SCRIPT}
ARG INFINITO_DOCKER_CLI_INSTALL_SCRIPT
ENV INFINITO_DOCKER_CLI_INSTALL_SCRIPT=${INFINITO_DOCKER_CLI_INSTALL_SCRIPT}
