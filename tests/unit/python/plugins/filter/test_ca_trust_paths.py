...
RUNTIME_SCRIPTS = (
    PROJECT_ROOT / "roles/sys-svc-compose-ca/files/python/compose_ca.py",
    PROJECT_ROOT / "roles/sys-svc-container/files/python/container.py",
)
...
class TestCaTrustPaths(unittest.TestCase):
    ...
    def test_env_handler_exports_the_host_spot(self):
        ...
        from utils.env.handlers.infinito.ca import cert_host as handler
