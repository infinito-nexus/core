# Unit tests for roles/sys-util-git-pull/files/python/sys_util_git_pull.py
#
...
def _load_sut():
    """
    Load roles/sys-util-git-pull/files/python/sys_util_git_pull.py as module "sys_util_git_pull"
