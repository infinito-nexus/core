...
_BASELINE: frozenset[str] = frozenset(
    {
        ...
        "roles/svc-opt-ssd-hdd/files/python/script.py",
        "roles/sys-ctl-rpr-container-soft/files/python/script.py",
        "roles/sys-svc-compose-ca/files/python/compose_ca.py",
        "roles/sys-svc-compose/files/python/compose.py",
        "roles/sys-svc-container/files/python/container.py",
        "roles/web-app-erpnext/files/python/apply/oidc_settings.py",
