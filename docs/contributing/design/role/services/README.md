...
| [mcp.md](mcp.md)       | `mcp` service block: fields, allowed values, endpoint metadata, client discovery. |
| [lifecycle.md](lifecycle.md) | Role lifecycle stages and what each one promises. |
