"""INFINITO_PARENT_IMAGE: distribution base image reference composed from
...
COMMENT = (
    "Distribution base image (Dockerfile FROM) composed from "
    "INFINITO_PARENT_IMAGE_OWNER, INFINITO_DISTRO and INFINITO_PARENT_IMAGE_TAG."
)


def compose(owner: str, distro: str, tag: str) -> str:
    return base_image(distro, owner=owner, tag=tag)
